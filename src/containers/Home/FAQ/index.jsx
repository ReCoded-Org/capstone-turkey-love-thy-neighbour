...
import img from "../../../utils/UndrawQuestion.png";
import "./index.scss";

function FAQ() {
  return (
    <Container className="faq-container d-flex align-items-center">
      <Row className="faq-row m-0">
        ...
        >
          ...
          <p>
            ...
            more isolated as time progresses. We care about you, and would like
            you to care about your neighbour so that, we could be a stronger
            community.
          </p>
